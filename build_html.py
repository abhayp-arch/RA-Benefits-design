...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero-section { max-width: 1280px; margin: 0 auto; padding: 80px 40px 70px; display: flex; align-items: center; justify-content: flex-start; gap: clamp(60px, 10vw, 180px); }
    ...
    /* ── RESOURCE CARDS ── */
    .cards-section { max-width: 1400px; margin: 0 auto; padding: 40px 60px 80px; }
    ...
    @media (min-width: 1440px) {
      ...
      .hero-section { max-width: 1440px; padding: 90px 60px 80px; }
      .cards-section { max-width: 1440px; padding: 40px 60px 80px; }
      .cards-grid { gap: 32px; }
    ...
    @media (min-width: 1920px) {
      ...
      .hero-section { max-width: 1700px; padding: 100px 80px 90px; gap: 240px; }
      .hero-left { max-width: 800px; }
      .hero-heading { font-size: 64px; }
      .member-card-widget { min-width: 440px; max-width: 480px; padding: 40px; }
      .cards-section { max-width: 1700px; padding: 50px 80px 100px; }
      .cards-grid { gap: 40px; }
      ...
      <div class="resource-card" id="card-job-postings">
        ...
        <div class="card-box">
          <div class="card-content">
            <div>
              <div class="card-tags"><span class="tag-free" style="background:rgba(28,117,187,0.1); color:#1C75BB;">Free Access</span><span class="tag-cat" style="color:#555;">Hiring &bull; Staffing</span></div>
              <h2 class="card-title">Complimentary access to 2 job postings every month</h2>
            ...
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" id="btn-job-postings">View Details</a>
          </div>
        </div>
      </div>
        ...
        <div class="card-box">
          <div class="card-content">
            <div>
              ...
              <h2 class="card-title">Google Reviews Response Templates</h2>
              <p class="card-desc">Professional, Ready-To-Use Responses For 1-5 Star Reviews&#8212;Save Time And Stay Consistent.</p>
            </div>
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" id="btn-google-reviews">View Details</a>
          </div>
        </div>
      </div>

      <div class="resource-card" id="card-delivery-menu">
        <div class="card-img-wrap"><img class="card-img" src="IMG_CHALKBOARD" alt="Restaurant menu chalkboard" /></div>
        <div class="card-box">
          <div class="card-content">
            <div>
              <div class="card-tags"><span class="tag-free">Free Templates</span><span class="tag-cat">Reputation &bull; Reviews</span></div>
              <h2 class="card-title">Delivery Menu Optimization Guide</h2>
              <p class="card-desc">A Practical Playbook To Improve Delivery Menus&#8212;What Sells, What Hurts Margins, And What To Remove.</p>
            </div>
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" id="btn-delivery-menu">View Details</a>
          </div>
        </div>
      </div>

      <div class="resource-card" id="card-reels-video">
        <div class="card-img-wrap"><img class="card-img" src="IMG_REELS" alt="Food for reels content" /></div>
        <div class="card-box">
          <div class="card-content">
            <div>
              <div class="card-tags"><span class="tag-free">Free Templates</span><span class="tag-cat">Reputation &bull; Reviews</span></div>
              <h2 class="card-title">Reels &amp; Short Video Coaching Kit</h2>
              <p class="card-desc">A Simple Framework + Examples For Filming Food Content That Performs On Reels/Tiktok/Shorts.</p>
            </div>
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" id="btn-reels-video">View Details</a>
          </div>
        </div>
      </div>

      <div class="resource-card" id="card-near-me">
        <div class="card-img-wrap"><img class="card-img" src="IMG_NEARME" alt="Overhead restaurant food spread" /></div>
        <div class="card-box">
          <div class="card-content">
            <div>
              <div class="card-tags"><span class="tag-free">Free Templates</span><span class="tag-cat">Reputation &bull; Reviews</span></div>
              <h2 class="card-title">&#8220;Near Me&#8221; Search Optimization Guide</h2>
              <p class="card-desc">Step-By-Step Checklist To Show Up When Guests Search &#8220;Near Me&#8221; (And Turn Views Into Visits).</p>
            </div>
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" id="btn-near-me">View Details</a>
          </div>
        </div>
      </div>

      <div class="resource-card" id="card-email-list">
        <div class="card-img-wrap"><img class="card-img" src="IMG_WOMAN" alt="Woman enjoying restaurant meal" /></div>
        <div class="card-box">
          <div class="card-content">
            <div>
              <div class="card-tags"><span class="tag-free">Free Templates</span><span class="tag-cat">Reputation &bull; Reviews</span></div>
              <h2 class="card-title">Restaurant Email List Builder Toolkit</h2>
              <p class="card-desc">In-Store + Online Tactics To Build A List Ethically, Plus Copy Templates That Convert.</p>
            </div>
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" id="btn-email-list">View Details</a>
          </div>
        </div>
      </div>

      <div class="resource-card" id="card-sms-templates">
        <div class="card-img-wrap"><img class="card-img" src="IMG_BAR" alt="Upscale bar interior" /></div>
        <div class="card-box">
          <div class="card-content">
            <div>
              <div class="card-tags"><span class="tag-free">Free Templates</span><span class="tag-cat">Reputation &bull; Reviews</span></div>
              <h2 class="card-title">Sms Templates For Slow Nights</h2>
              <p class="card-desc">Plug-And-Play Text Templates For &#8220;Tonight Only&#8221; Promos&#8212;Without Sounding Spammy.</p>
            </div>
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" id="btn-sms-templates">View Details</a>
          </div>
        </div>
      </div>
      ...
      <div class="resource-card" id="card-chomp-show">
        ...
        <div class="card-box">
          <div class="card-content">
            <div>
              <div class="card-tags"><span class="tag-free">Free Templates</span><span class="tag-cat">Reputation &bull; Reviews</span></div>
              <h2 class="card-title">Get Featured On The Chomp Show</h2>
              <p class="card-desc">A Member Perk To Apply For A Feature&#8212;Share Your Story And Get Real Exposure.</p>
            </div>
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" id="btn-chomp-show">View Details</a>
          </div>
        </div>
      </div>
      ...
      <div class="resource-card" id="card-free-website">
        ...
        <div class="card-box">
          <div class="card-content">
            ...
            <a href="#" class="view-btn" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" onclick="window.location.href='details.html'" id="btn-free-website">View Details</a>
          </div>
        </div>
      </div>
...
html = html.replace("IMG_WAITER", imgs['img_waiter'])
html = html.replace("IMG_CHALKBOARD", imgs['img_chalkboard'])
html = html.replace("IMG_REELS", imgs['img_reels'])
html = html.replace("IMG_NEARME", imgs['img_nearme'])
html = html.replace("IMG_WOMAN", imgs['img_woman'])
html = html.replace("IMG_BAR", imgs['img_bar'])
html = html.replace("IMG_CHOMP", imgs['img_chomp'])
html = html.replace("IMG_LAPTOP", imgs['img_laptop'])
html = html.replace("IMG_LOGO", imgs['img_logo'])
html = html.replace("IMG_FAVICON", imgs['img_favicon'])
html = html.replace("IMG_JOB_POSTINGS", imgs['img_job_postings'])
